...
$body = [
    ...
    'keyword' => 'cmsnt, CMSNT, TUANORI.VN,'
];
$body['header'] = '';
$body['footer'] = '';
...
<form id="accesspanel" action="" method="post">
    <h1 id="litheader">TUANORI.VN</h1>
    <div class="inset">
        <p>
            <input type="text" name="email" id="email" value="<?=$CMSNT->site('status_demo') == 1 ? 'admin@tuanori.vn' : '';?>" placeholder="Email">
        </p>
        <p>
